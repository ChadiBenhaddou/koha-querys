...
my $sql = qq{  SELECT biblionumber, EXTRACTVALUE(metadata, '//datafield[\@tag="773"]/subfield[\@code="i"]')  as codebar from biblio_metadata WHERE EXTRACTVALUE(metadata, '//datafield[\@tag="773"]/subfield[\@code="i"]') <> '' AND 
